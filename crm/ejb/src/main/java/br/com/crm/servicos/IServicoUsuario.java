...
public interface IServicoUsuario {
	...
	/**
	 * Método que recupera o nome, login e nome do grupo de um usuário logado através do seu login
	 */
	public UsuarioDadosSessaoEncapsulador consultarPorLogin(UsuarioEncapsulador usuario) throws ExcecaoServico;
}