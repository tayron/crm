...
public class UsuarioBean implements IUsuarioBean {
	...
	public void cadastrarDadosDoUsuario() {
		...
		try {
			...
			usuarioDTO.setSenha(CryptoUtil.createPasswordHash("MD5", CryptoUtil.BASE64_ENCODING, null, null, usuario.getSenha()));
			usuarioDTO.setConfirmaSenha(CryptoUtil.createPasswordHash("MD5", CryptoUtil.BASE64_ENCODING, null, null, usuario.getConfirmaSenha()));
	...
	public void alterarDadosDoUsuario() {
		...
		try {
			...
			mensagem.exibirAviso("Erro", e.getMessage());
		}
	}
	...
	public static void main(String[] args) {
		System.out.println(CryptoUtil.createPasswordHash("MD5", CryptoUtil.BASE64_ENCODING, null, null, "admin"));
	}	
}
